...
Runs 474 tests across 19 test files with fully mocked external dependencies (a 20th file, `live-1cs.test.ts`, runs only when `ONE_CLICK_JWT` is set). No API key, funds, or network access required.
